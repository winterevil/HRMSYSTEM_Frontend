                    ...
                    <div className="right">
                        ...
                        <div className="notification d-flex">
                            <div className="notification d-flex">
                                {/* NOTIFICATION */}
                                <div
                                    className="dropdown d-flex position-relative"
                                    ref={notiRef}
                                >
                                    <a
                            ...
                            <div className="dropdown d-flex">
                                ...
                                <div className="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <a className="dropdown-item" href="#">
                                        <i className="dropdown-icon fa-solid fa-gear"></i>{" "}
                                        Settings
                                    </a>
                                    <div className="dropdown-divider"></div>
                                    <a className="dropdown-item" href="#">
                                        <i className="dropdown-icon fa-solid fa-circle-question"></i>{" "}
                                        Need help?
                                    </a>
                                    <a
                                        className="dropdown-item"
                                    ...
                                    >
                                        <i className="dropdown-icon fa-solid fa-lock-open"></i>{" "}
                                        Forgot Password
                                    </a>
                                    <a
                                        className="dropdown-item"
