    ...
    return (
        <div id="header_top" className="header_top">
            <div className="container">
                <div className="hleft">
                    <a className="header-brand" href="#"><img src="/assets/images/logo.jpeg" alt="Logo" className="brand-logo" /></a>
                ...
                <div className="hright">
                    <div className="dropdown">
                        <a href="javascript:void(0)" className="nav-link icon theme_btn" data-toggle="tooltip" data-placement="right" title="Themes">
                        ...
                        <a href="javascript:void(0)" className="nav-link user_btn" data-toggle="tooltip" data-placement="right" title="User Menu" ><img className="avatar" src="../../assets/images/user.jpg" alt="" />
                        </a>
                        <a href="javascript:void(0)" className="nav-link icon menu_toggle" data-toggle="tooltip" data-placement="right" title="Toggle">
